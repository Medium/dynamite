 ...
 *
 * @param {Object.<string,AWSPackedObject>|Array.<Object.<string,AWSPackedObject>>} object Dynamo AttributeValue map object(s)
 ...
 * @return {Object.<string,AWSPackedObject>|Array.<Object.<string,AWSPackedObject>>|null} The object in Dynamo AttributeValue map.
 */
...
/**
 * @param {!AWSPackedObject} obj Dynamo AttributeValue value.
 * @return {string}
 */
...
/**
 * @param {!AWSPackedObject} set
 * @param {!AWSPackedObject} additions
 * @return {AWSPackedObject}
 */
function addToSet(set, additions) {
  if (objectToType(set) != objectToType(additions)) {
    throw new Error('Trying to append to a non-array')
  }
...
/**
 * @param {!AWSPackedObject} set
 * @param {!AWSPackedObject} deletions
 * @return {?AWSPackedObject}
 */
function deleteFromSet(set, deletions) {
  if (objectToType(set) != objectToType(deletions)) {
    throw new Error('Trying to append to a non-array')
  }
...
/**
 * @param {!AWSPackedObject} number
 * @param {!AWSPackedObject} addition
 * @return {AWSPackedObject}
 */
...
module.exports = {
  AWSPackedObject: AWSPackedObject,
